...
def _rewrite_for_image_enhancement(prompt: str) -> str:
    ...
    rewritten = _call_groq_text(
        system_prompt=(
            ...
            "'premium', 'high-end', 'polished', 'refined', 'upscale', 'editorial', or 'luxury' → "
            "elegant soft directional light with smooth luminosity transitions, balanced contrast with lifted midtones and controlled highlights, "
            "refined skin detail with natural pore texture preserved (no smoothing, no airbrushed finish), "
            "crisp sharpness on hair, eyes, and fabric, and tasteful professional color grading — "
            "high-end editorial retouching for a real person, not a cinematic filter or fantasy effect; "
            ...
            "These keywords mean lighting quality and color grading only — never scene, subject, background, clothing, or identity changes. "
            "Do NOT produce plastic skin, airbrushed smoothing, glam over-processing, fantasy lighting effects, or identity drift. "
