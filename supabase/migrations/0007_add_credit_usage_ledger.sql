...
DROP FUNCTION IF EXISTS dev.create_credit_charged_job_with_ledger(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, INTEGER);
CREATE FUNCTION dev.create_credit_charged_job_with_ledger(
    p_user_id UUID,
    p_filename TEXT,
    p_object_key TEXT,
    p_mode TEXT,
...
DROP FUNCTION IF EXISTS public.create_credit_charged_job_with_ledger(UUID, TEXT, TEXT, TEXT, TEXT, TEXT, INTEGER, INTEGER);
CREATE FUNCTION public.create_credit_charged_job_with_ledger(
    p_user_id UUID,
    p_filename TEXT,
    p_object_key TEXT,
    p_mode TEXT,
